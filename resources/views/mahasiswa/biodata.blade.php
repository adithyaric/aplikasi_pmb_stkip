                            ...
                            <div class="col-md-8">
                                ...
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#tab_5" data-toggle="tab">DATA KELUARGA & KARTU</a></li>
                                        <li><a href="#tab_6" data-toggle="tab">PEMBERI REKOMENDASI</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1">
                                            <div class="box-body">
                                                <i><strong class="blink" style="color: red !important;">Isi Formulir Dengan Lengkap Hingga Formulir Pemberi Rekomendasi  dan Gunakan Huruf Besar!</strong></i><hr>
                                        ...
                                        <label for="exampleInputPassword1">Upload Photo 3x4</label>
                                        <input type="file" class="form-control " required name="pas_photo" value="{{ old('pas_photo') }}"
                                            ...
                                            <div class="form-group @error('agama') has-error @enderror ">
                                                ...
                                                <select name="agama" class="form-control">
                                                    <option value="ISLAM"
                                                        {{ $biodata->agama == 'ISLAM' ? 'selected' : ''  }}>ISLAM
                                                    </option>
                                                    ...
                                                    <option value="KATOLIK"
                                                        ...
                                                        KATOLIK</option>
                                                    <option value="HINDU"
                                                        {{ $biodata->agama == 'HINDU' ? 'selected' : ''  }}>HINDU
                                                    </option>
                                                    <option value="BUDDHA"
                                                        {{ $biodata->agama == 'BUDDHA' ? 'selected' : ''  }}>BUDDHA
                                                    </option>
                                                    <option value="KONGHUCU"
                                                        {{ $biodata->agama == 'KONGHUCU' ? 'selected' : ''  }}>KONGHUCU
                                                    </option>
                                                </select>
                                                @else
                                                <select name="agama" class="form-control">
                                            ...
                                            <div class="form-group @error('anak') has-error @enderror ">
                                                ...
                                                <input type="number" class="form-control" required name="anak"
                                            ...
                                            <div class="form-group @error('jumlah_saudara') has-error @enderror ">
                                                ...
                                                <input type="number" class="form-control" required name="jumlah_saudara"
                                            ...
                                            <div class="form-group @error('status_sipil') has-error @enderror ">
                                                <label for="exampleInputPassword1">Status Kewarganegaraan </label>
                                                @if($biodata)
                                            ...
                                            <div class="form-group @error('phone') has-error @enderror ">
                                                ...
                                                <input type="number" class="form-control " required name="phone"
                                                    value="62{{ old('phone') ?? $biodata == null ? '' : $biodata->phone }}"
                                            ...
                                            <a href="#tab_2" data-toggle="tab" class="btn btn-success">Selanjutnya</a>
                                            </form>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                                ...
                                                <div class="form-group @error('jalan') has-error @enderror ">
                                                    ...
                                                    <input type="text" required class="form-control " name="jalan"
                                                ...
                                                <hr><strong style="color: red !important;"><i>Klik Simpan Lalu Klik Selanjutnya</i></strong><hr>
                                            <button type="submit" class="btn btn-primary">Simpan</button>
                                            <a href="#tab_3" data-toggle="tab" class="btn btn-success">Selanjutnya</a>
                                            </form>
                                    ...
                                    <div class="tab-pane" id="tab_3">
                                        ...
                                        <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                            ...
                                            <div class="form-group @error('name') has-error @enderror">
                                                ...
                                                <input type="number" required class="form-control" name="tahun_lulus"
                                            ...
                                            <div class="form-group @error('npsn') has-error @enderror">
                                                ...
                                                <input type="number" required class="form-control " name="npsn"
                                            ...
                                            <div class="form-group @error('alamat_sekolah') has-error @enderror">
                                                <label for="exampleInputPassword1">ALAMAT SEKOLAH </label>
                                                <input type="text" required class="form-control " name="alamat_sekolah"
                                            ...
                                            <div class="form-group @error('kab_sekolah') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control " name="kab_sekolah"
                                            ...
                                            <div class="form-group @error('prov_sekolah') has-error @enderror">
                                                <label for="exampleInputPassword1">PROVINSI SEKOLAH </label>
                                                <input type="text" required class="form-control " name="prov_sekolah"
                                            ...
                                            <hr><strong style="color: red !important;"><i>Klik Simpan Lalu Klik Selanjutnya</i></strong><hr>
                                            <button type="submit" class="btn btn-primary">Simpan</button>
                                            <a href="#tab_4" data-toggle="tab" class="btn btn-success">Selanjutnya</a>
                                        </form>
                                    </div>
                                        ...
                                        <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                            ...
                                            <div class="form-group @error('rencana') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control "
                                                    ...
                                                    name="rencana_tinggal" placeholder="Masukan Rencana Tinggal">
                                                @error('rencana')
                                                <span class="help-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group @error('jarak_tempuh') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control " name="jarak_tempuh"
                                            ...
                                            <div class="form-group @error('asal_pembiayaan') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control " name="asal_pembiayaan"
                                            ...
                                            <hr><strong style="color: red !important;"><i>Klik Simpan Lalu Klik Selanjutnya</i></strong><hr>
                                            <button type="submit" class="btn btn-primary">Simpan</button>
                                            <a href="#tab_5" data-toggle="tab" class="btn btn-success">Selanjutnya</a>
                                        </form>
                                    </div>
                                    <div class="tab-pane" id="tab_5">
                                        ...
                                        <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                            ...
                                            <div class="form-group @error('nama_kk') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control" name="nama_kk"
                                            ...
                                            <div class="form-group @error('pekerjaan_ayah') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control" name="pekerjaan_ayah"
                                            ...
                                            <div class="form-group @error('pekerjaan_ibu') has-error @enderror">
                                                ...
                                                <input type="text" required class="form-control" name="pekerjaan_ibu"
                                            ...
                                            <div class="form-group @error('np_kip') has-error @enderror">
                                                <label for="exampleInputPassword1">Nomor Pendaftaran KIP-Kuliah (Web Kemendikbud) <a href="https://kip-kuliah.kemdikbud.go.id/siswa/auth/login" target="_blank">Login KIP-Kuliah</a> </label>
                                            ...
                                            <div class="form-group @error('ka_kip') has-error @enderror">
                                                <label for="exampleInputPassword1">Kode Akses KIP-Kuliah </label>
                                            ...
                                            <div class="form-group @error('kks') has-error @enderror">
                                                <label for="exampleInputPassword1">Nomor KKS (Jika ada) </label>
                                            ...
                                            <div class="form-group @error('pkh') has-error @enderror">
                                                <label for="exampleInputPassword1">Nomor PKH (Jika ada) </label>
                                           ...
                                           <hr><strong style="color: red !important;"><i>Klik Simpan Lalu Klik Selanjutnya</i></strong><hr>
                                            <button type="submit" class="btn btn-primary">Simpan</button>
                                            <a href="#tab_6" data-toggle="tab" class="btn btn-success">Selanjutnya</a>
                                        </form>
                                    </div>
                                    <!-- /.tab-pane -->
                                    ...
                                    <div class="tab-pane" id="tab_6">
                                        <i><strong style="color: red !important;">Isi Formulir Dengan Lengkap Hingga Formulir Pemberi Rekomendasi  dan Gunakan Huruf Besar!</strong></i><hr>
                                        <form action="{{ route('mahasiswa.create.biodata') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="form-group @error('nama_rekomendasi') has-error @enderror ">
                                                <label for="exampleInputPassword1">Nama Perekom (Isi "-" Jika Tidak
                                                    Ada)</label>
                                            ...
                                            <div class="form-group @error('wa_rekomendasi') has-error @enderror ">
                                                <label for="exampleInputPassword1">Nomor Hp Perekom (Biarkan Kosong Jika Tidak Ada Perekom) </label>
                                                <input type="number" class="form-control " name="wa_rekomendasi"
                                                    value="62{{ old('wa_rekomendasi') ?? $biodata == null ? '' : $biodata->wa_rekomendasi }}"
                                            ...
                                            <div class="form-group @error('prodi_perekom') has-error @enderror ">
                                                ...
                                                <select name="prodi_perekom" class="form-control">
                                                    ...
                                                    <option value="BUKAN MAHASISWA"
                                                        {{ $biodata->prodi_perekom == 'BUKAN MAHASISWA' ? 'selected' : ''  }}>BUKAN MAHASISWA
                                                    </option>
                                                    <option value="PENDIDIKAN GURU SEKOLAH DASAR"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN GURU SEKOLAH DASAR' ? 'selected' : ''  }}>PENDIDIKAN GURU SEKOLAH DASAR
                                                    </option>
                                                    <option value="PENDIDIKAN BAHASA DAN SASTRA INDONESIA"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN BAHASA DAN SASTRA INDONESIA' ? 'selected' : ''  }}>PENDIDIKAN BAHASA DAN SASTRA INDONESIA
                                                    </option>
                                                    <option value="PENDIDIKAN BAHASA INGGRIS"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN BAHASA INGGRIS' ? 'selected' : ''  }}>PENDIDIKAN BAHASA INGGRIS
                                                    </option>
                                                    <option value="PENDIDIKAN INFORMATIKA"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN INFORMATIKA' ? 'selected' : ''  }}>PENDIDIKAN INFORMATIKA
                                                    </option>
                                                    <option value="PENDIDIKAN JASMANI, KESEHATAN DAN REKREASI"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN JASMANI, KESEHATAN DAN REKREASI' ? 'selected' : ''  }}>PENDIDIKAN JASMANI, KESEHATAN DAN REKREASI
                                                    </option>
                                                    <option value="PENDIDIKAN MATEMATIKA"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN MATEMATIKA' ? 'selected' : ''  }}>PENDIDIKAN MATEMATIKA
                                                    </option>
                                                    <option value="PENDIDIKAN SEJARAH"
                                                        {{ $biodata->prodi_perekom == 'PENDIDIKAN SEJARAH' ? 'selected' : ''  }}>PENDIDIKAN SEJARAH
                                                    </option>
                                                </select>
                                                @else
                                                <select name="prodi_perekom" class="form-control">
                                            ...
                                            <div class="form-group @error('nim_perekom') has-error @enderror ">
                                                <label for="exampleInputPassword1">NIM Perekom (Biarkan Kosong Jika Perekom Bukan Mahasiswa) </label>
                                                <input type="number" class="form-control " name="nim_perekom"
