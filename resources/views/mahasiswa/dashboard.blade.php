    ...
    @if($mahasiswa->status == 'TES / CBT' || $mahasiswa == 'INTERVIEW')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h5>Hai, {{ Auth::user()->name }} !</h5>Pantau Terus Aplikasi Ini Untuk Mendapatkan Informasi Terkini
        ...
        <div class="col-md-6">
            <div class="box">
                <div class="box-body text-center">
                    ...
                    <hr>
                    @if(Auth::user()->photo)
                    <img src="{{ Storage::url( Auth::user()->photo) }}" class="w-100" style="width:150px; height:150px"
                        alt="">
                    <br>
                    @else
                    <img src="{{ asset('assets/img/default.jpg') }}" class="w-100" style="width:150px; height:150px"
                        alt="">
                    <br>
                    @endif
                    <br>
