                ...
                <div class="box box-primary">
                    ...
                    <form method="POST" action="{{ route('PrintPDF') }}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" required> Data yang telah saya submit menjadi data final yang
                                    tidak akan berubah.
                                </label>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body blink" style="border: 2px solid black; padding: 5px; width: 60%;">
                                        ...
                                        <b>
                                            ...
                                            aplikasi PMB ini. Data akan terkunci otomatis dan tidak dapat di buka kembali
                                            oleh
