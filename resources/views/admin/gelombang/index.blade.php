            ...
            <form action="{{ route('admin.gelombang.store') }}" method="post">
                @csrf
                   <div class="form-group @error('nisn') has-error @enderror">
                     ...
                     <input onkeyup="this.value = this.value.toUpperCase();" type="text" class="form-control " required name="nama" placeholder="Masukkan Gelombang">
                     <label for="exampleInputEmail1">Biaya Pendaftaran</label>
                     <input type="number" class="form-control " required name="nominal" placeholder="Masukkan Nominal">
        ...
        <div class="modal-body">
            <form action="{{ route('admin.gelombang.store') }}" method="post">
                @csrf
                   <div class="form-group @error('nisn') has-error @enderror">
                     <label for="exampleInputEmail1">Gelombang</label>
                     <input onkeyup="this.value = this.value.toUpperCase();" type="text" class="form-control " required name="nama" id="nama" placeholder="Masukan Gelombang">
                     <input type="hidden" class="form-control " required name="id" id="id" placeholder="Masukan Gelombang">
                     <label for="exampleInputEmail1">Biaya Pendaftaran</label>
                     <input type="text" class="form-control " required name="nominal" id="nominal" placeholder="Masukan Nominal">
