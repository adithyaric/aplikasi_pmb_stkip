...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ route('login') }}"><img src="{{ asset('assets/img/stkip.png') }}" width="100px"
                    height="100px"><br>
        ...
        <div class="login-box-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group has-feedback">
                    <input id="email" type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn"
                        value="{{ old('nisn') }}" required autocomplete="nisn" placeholder="Username" autofocus>
                            ...
                            <form class="login-form" action="{{ route('login') }}" method="post">
                                ...
                                <div class="form-group has-feedback">
                                    <input id="email" type="text"
                                        ...
                                        value="{{ old('nisn') }}" required autocomplete="nisn" placeholder="Username"
                                        autofocus>
